...
arch=$(uname -m)
if [ "$arch" == "armv7l" ]; then
    curl -sSfL --create-dirs -o ~/mqtt-bridge/bridge https://raw.githubusercontent.com/sarakha63/wallbox/main/bridge-armhf
elif [ "$arch" == "aarch64" ]; then
    curl -sSfL --create-dirs -o ~/mqtt-bridge/bridge https://raw.githubusercontent.com/sarakha63/wallbox/main/bridge-arm64
else
