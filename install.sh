...
arch=$(uname -m)
if [ "$arch" == "armv7l" ]; then
    curl -sSfL --create-dirs -o ~/mqtt-bridge/bridge https://github.com/sarakha63/wallbox/blob/main/bridge-armhf
elif [ "$arch" == "aarch64" ]; then
    curl -sSfL --create-dirs -o ~/mqtt-bridge/bridge https://github.com/sarakha63/wallbox/blob/main/bridge-arm64
else
